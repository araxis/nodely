...
- [x] Replace the generic toolbox list with a compact top stencil strip and scene-specific previews.
- [x] Make runtime property editor controls stretch to the inspector column.
